...
| Ebene | Befehl | Umfang |
| --- | --- | --- |
| Unit / Service (Client) | `npm run test:unit` | 1315 Tests, jsdom, Firestore gemockt |
...
Der globale Wert (aktuell ~75 % Statements, ~70 % Branches) ist bewusst niedriger: Er umfasst
