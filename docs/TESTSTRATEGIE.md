...
| Ebene | Befehl | Umfang |
| --- | --- | --- |
| Unit / Service (Client) | `npm run test:unit` | 1375 Tests, jsdom, Firestore gemockt |
...
Der globale Wert (aktuell ~77 % Statements, ~71 % Branches) ist bewusst niedriger: Er umfasst
