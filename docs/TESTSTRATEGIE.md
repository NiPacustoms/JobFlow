...
| Ebene | Befehl | Umfang |
| --- | --- | --- |
| Unit / Service (Client) | `npm run test:unit` | 1561 Tests, jsdom, Firestore gemockt |
...
Der globale Wert (aktuell ~82 % Statements, ~74 % Branches) ist bewusst niedriger: Er umfasst
