...
| Ebene | Befehl | Umfang |
| --- | --- | --- |
| Unit / Service (Client) | `npm run test:unit` | 1532 Tests, jsdom, Firestore gemockt |
...
Der globale Wert (aktuell ~81 % Statements, ~73 % Branches) ist bewusst niedriger: Er umfasst
