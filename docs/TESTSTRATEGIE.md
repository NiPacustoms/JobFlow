...
| Ebene | Befehl | Umfang |
| --- | --- | --- |
| Unit / Service (Client) | `npm run test:unit` | 959 Tests, jsdom, Firestore gemockt |
...
Der globale Wert (aktuell ~56 % Statements, ~65 % Branches) ist bewusst niedriger: Er umfasst
