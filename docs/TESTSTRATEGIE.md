...
| Ebene | Befehl | Umfang |
| --- | --- | --- |
| Unit / Service (Client) | `npm run test:unit` | 917 Tests, jsdom, Firestore gemockt |
...
Der globale Wert (aktuell ~52 % Statements, ~64 % Branches) ist bewusst niedriger: Er umfasst
